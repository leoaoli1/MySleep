...
<html style="background-image: url('assets/img/bkg-lg.jpg')">
	...
	<div class="wrapper" >
      ...
      <?php if ($config) {
			     ...
			     <li><a href="#" onclick="location.href='fifth-grade-lesson-activity-menu?lesson=3&activity=4'">Activity Four</a></li>
			      ...
			      <li><a href="#" onclick="location.href='body-changer-hb-simulation-description'">Body Changer Heart Rate Description</a></li>
		    ...
		    <form action="body-changer-hb-simulation" method="post">
			<div class="col-md-offset-2 col-md-offset-8 col-sm-offset-2 col-sm-8">
			    <h2 style="font-family:Comic Sans MS; color:blue;font-size:150%;" >
				<?php if($_SESSION['clickTimesHB']>=1){ ?>
					...
					<li>When you see the heart on the screen count the number of beats for 15 seconds before hitting the space bar. By doing this, you are measuring heart rate, or pulse. </li>
					<li>The data displayed on the screen will be the average heart rate for people with that amount of sleep.</li>
					<li>Repeat.  When you have 3 data points, you will be asked to draw a conclusion about the data.</li>
				    </ol>
				<?php }else{ ?>
				    <!-- <p style="color:black">Select a number of hours of sleep. Then click the Simulate box. When you see the “heart” on the screen count the number of beats. Then hit the space bar.  By doing this, you are measuring the pulse. For the purposes of this simulation, however, the result displayed in the graph may not be the same as your count.</p>
				    <p>After three trials, you will be asked to draw a conclusion about the relationship between the amount of nightly sleep and heart rate.</p>-->
				    <ol>
					<li>Select a number of hours of sleep. Click Simulate </li>
					<li>When you see the heart on the screen count the number of beats for 15 seconds before hitting the space bar. By doing this, you are measuring heart rate, or pulse. </li>
					<li>The data displayed on the screen will be the average heart rate for people with that amount of sleep.</li>
    ...
    <script type="text/javascript">
     var radio = <?php echo json_encode($_SESSION['radioHB']); ?>;
     //console.log(radio);
