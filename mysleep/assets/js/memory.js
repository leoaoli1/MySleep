...
function formatoutputdata(text) {
    ...
    out = out + '<tr><td>Score<sup>1</sup></td><td colspan="5">'+(totalCorrect/totalRounds).toFixed(2)+'</td></tr>';
    return out
}
    ...
    run: function () {
        ...
        switch (task_nback.step) {
            ...
            case 13:
                ...
                switch(keyStatusFormatted){case 1: keyStatusFormatted = "Correct"; totalCorrect++;break;case 2: keyStatusFormatted = "Incorrect"; break; case 3: keyStatusFormatted = "Response-Timed-Out";break;};
...
var block_training = {
    ...
    start: function () {
        ...
        block_training.trial_counter_per_task[0] = totalRounds;
        psy_clear_stimulus_counters_db();
        block_training.run()
    },
    run: function () {
