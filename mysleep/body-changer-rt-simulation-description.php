...
<html style="background-image: url('assets/img/bkg-lg.jpg')">
	...
	<div class="wrapper" >
      ...
      <?php if ($config) {
			...
			<!-- Tab One -->
				...
				<div class="item active"><img src="images/body-changer/brain_image.jpg" alt="First slide image" class="center-block image-fill" style="width:400px; height:100px">
				    <div class="carousel-caption">
					<h3>Brain MRI </h3>
					<p>(c) http://www.viralnovelty.net/10-things-happen-suppress-emotions/</p>
				    </div>
				</div>
			    </div>
			    <div class="col-md-offset-2 col-md-offset-8 col-sm-offset-2 col-sm-8">
				<h1 class="text-center" style="font-family:Comic Sans MS; color:red;font-size:200%;"><strong>Sleep and Nervous System</strong></h1>
				<h2 style="font-family:Comic Sans MS; color:blue;font-size:150%;" ><p style="color:blue">Reaction, or response time, is an indicator of how quickly your brain and nerves can detect and respond to a change in your surrounding environment. Fast reaction times can protect you from danger and make a difference in many sports and games. Slow reaction times increase risk of accidents and affect performance in many skill tasks.</p></h2>
			...
			<!-- Tab Two -->
				...
				<div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
				    <h2 class="title"><strong>Does the amount of sleep affect your reaction time?</strong></h2>
				...
				<div class="row col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
				    <h5>If nightly sleep decreases, then reaction time will:</h5>
				</div>
				...
				<a href="body-changer-rt-simulation-input" class="btn btn-info btn-lg" role="button">Next</a>
			    </div>
			</div>
		    </div>
		</div>
	...
	$("#id_increase").click(function(){
	 localStorage.setItem('rtH', 'increase');
     });

     $("#id_decrease").click(function(){
	 localStorage.setItem('rtH', 'decrease');
     });

     $("#id_noChange").click(function(){
	 localStorage.setItem('rtH', 'no change');
     });
    </script>
</html>
