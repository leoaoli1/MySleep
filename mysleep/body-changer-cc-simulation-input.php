...
<html style="background-image: url('assets/img/bkg-lg.jpg')">
	...
	<div class="wrapper" >
      ...
      <?php if ($config) {
			      ...
			      <li><a href="#" onclick="location.href='body-changer-cc-simulation-description'">Body Changer Catch a Cold Description</a></li>
		    ...
		    <form action="body-changer-cc-simulation" method="post">
			<div class="col-md-offset-2 col-md-offset-8 col-sm-offset-2 col-sm-8">
			    <h4 style="font-family:Comic Sans MS; color:blue;font-size:150%;" >
				<?php if($_SESSION['clickTimesCC']>=1){ ?>
					...
					<li>When you see the “rhinovirus cells” on the screen estimate the number. This number reflects the risk of infection. Then hit the space bar.</li>
					<li>The data displayed on the graph will be the average risk of infection for people with that amount of sleep.</li>
					<li>Repeat.  When you have 3 data points, you will be asked to draw a conclusion about the data.</li>
				    </ol>
				<?php }else{ ?>
				    <!-- <p style="color:black;">Select a number of hours of sleep. Then click the Simulate box. When you see the “rhinovirus cells” on the screen estimate the number. This number reflects the risk of infection. By doing this, you are performing one of the functions performed by your body’s immune system.  Then hit the space bar.  For the purposes of this simulation, however, the result displayed is actual data from research studies.   </p>
				    <p>After three trials, you will be asked to draw a conclusion about the relationship between the amount of nightly sleep and the immune system.  </p>-->
				    <ol>
					<li>Select a number of hours of sleep. Click Simulate.</li>
					<li>When you see the “rhinovirus cells” on the screen estimate the number. This number reflects the risk of infection. Then hit the space bar.</li>
					<li>The data displayed on the graph will be the average risk of infection for people with that amount of sleep.</li>
    ...
    <script type="text/javascript">
     var radio = <?php echo json_encode($_SESSION['radioCC']); ?>;
     //console.log(radio);
